...
Restores from cache, or downloads and caches CMake **v3.19.1** and Ninja **v1.10.2**.
...
```yaml
    ...
    - name: Get specific version CMake, v3.19.1
      uses: lukka/get-cmake@v3.19.1   ⟸ THIS IS THE ONE LINER YOU NEED
```
